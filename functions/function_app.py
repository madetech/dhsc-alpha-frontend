...
def sql_test(req: func.HttpRequest) -> func.HttpResponse:
    ...
    df = pd.read_sql("select TOP 100 geographical_description, measure_group_description, outcome FROM ASCOF.all_metrics WHERE geographical_level='Region' AND fiscal_year='2023'", conn)
